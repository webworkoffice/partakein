...
public class EventNotificationTestDataProvider extends TestDataProvider<EventNotification> {
    ...
    public EventNotification create(long pkNumber, String pkSalt, int objNumber) {
        ...
        return new EventNotification(id, "eventId", new ArrayList<String>(), NotificationType.BECAME_TO_BE_CANCELLED, new DateTime(objNumber), null);
    }

    @Override
    public List<EventNotification> createSamples() {
