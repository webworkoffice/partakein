...
public class EventEnqueteEditActionTest extends ActionControllerTest {
    ...
    public void testToShowWithLogin() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/enquete/" + TestDataProvider.DEFAULT_EVENT_ID);
    ...
    public void testToShowInvalidEventId() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/enquete/" + TestDataProvider.INVALID_EVENT_ID);
        loginAs(proxy, EVENT_OWNER_ID);
    ...
    public void testToShowWithoutId() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/enquete/");
        loginAs(proxy, EVENT_OWNER_ID);
    ...
    public void testToShowWithNonUUID() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/enquete/some-invalid-event-id");
        loginAs(proxy, EVENT_OWNER_ID);
