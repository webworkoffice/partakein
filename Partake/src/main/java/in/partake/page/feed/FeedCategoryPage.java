...
public class FeedCategoryPage extends PartakeFeedPage {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(FeedCategoryPage.class);
    
    // /feed/category/{category}
    public FeedCategoryPage(PageParameters params) {
