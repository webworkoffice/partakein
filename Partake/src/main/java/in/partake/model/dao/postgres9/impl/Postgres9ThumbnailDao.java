...
class EntityThumbnailMapper extends Postgres9EntityDataMapper<ThumbnailData> {
    public ThumbnailData map(Postgres9Entity entity) throws DAOException {
        if (entity == null)
            return null;

        JSONObject obj = JSONObject.fromObject(new String(entity.getBody(), UTF8));
        ThumbnailData thumbnailData = new ThumbnailData(obj);
...
public class Postgres9ThumbnailDao extends Postgres9Dao implements IThumbnailAccess {
    static final String TABLE_NAME = "ThumbnailEntities";
    static final int CURRENT_VERSION = 1;
    static final String USER_INDEX_TABLE_NAME = "ThumbnailUserIndex";
    ...
    @Override
    public void put(PartakeConnection con, ThumbnailData imageData) throws DAOException {
        Postgres9Connection pcon = (Postgres9Connection) con;
    ...
    @Override
    public ThumbnailData find(PartakeConnection con, String id) throws DAOException {
    ...
    @Override
    public DataIterator<ThumbnailData> getIterator(PartakeConnection con) throws DAOException {
        return new MapperDataIterator<Postgres9Entity, ThumbnailData>(mapper, entityDao.getIterator((Postgres9Connection) con));
    }
