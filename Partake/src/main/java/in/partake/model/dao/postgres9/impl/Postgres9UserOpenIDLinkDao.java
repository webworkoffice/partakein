...
public class Postgres9UserOpenIDLinkDao extends Postgres9Dao implements IUserOpenIDLinkAccess {
    ...
    @Override
    public UserOpenIDLink find(PartakeConnection con, String openId) throws DAOException {
    ...
    public UserOpenIDLink findById(PartakeConnection con, String id) throws DAOException {
