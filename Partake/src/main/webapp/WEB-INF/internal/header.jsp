        ...
        <div class="container">
            ...
            <ul class="nav pull-right">
                <li class="dropdown hidden-phone">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://github.com/partakein/partake/wiki/FAQ">よくある質問</a></li>
                        <li><a href="https://github.com/partakein/partake/issues">ご要望・バグ報告</a></li>
                        <li class="divider"></li>
                        <li><a href="/contact">お問い合わせ</a></li>
                        <li><a href="/termofuse">利用規約</a></li>
                        <li class="divider"></li>
                        <li><a href="https://github.com/partakein/">Copyright &copy; The PARTAKE Committers</a></li>
                    </ul>
                </li>
