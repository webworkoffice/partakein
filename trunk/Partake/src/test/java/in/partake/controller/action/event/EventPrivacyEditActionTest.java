...
public class EventPrivacyEditActionTest extends ActionControllerTest {
    ...
    public void testToShowWithLogin() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/privacy/" + TestDataProvider.DEFAULT_EVENT_ID);
    ...
    public void testToShowInvalidEventId() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/privacy/" + TestDataProvider.INVALID_EVENT_ID);
        loginAs(proxy, EVENT_OWNER_ID);
    ...
    public void testToShowWithoutId() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/privacy/");
        loginAs(proxy, EVENT_OWNER_ID);
    ...
    public void testToShowWithNonUUID() throws Exception {
        ActionProxy proxy = getActionProxy("/events/edit/privacy/some-invalid-event-id");
        loginAs(proxy, EVENT_OWNER_ID);
