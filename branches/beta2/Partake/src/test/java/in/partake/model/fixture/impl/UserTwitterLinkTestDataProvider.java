...
public class UserTwitterLinkTestDataProvider extends TestDataProvider<UserTwitterLink> {
    ...
    public void createFixtures(PartakeConnection con, IPartakeDAOs daos) throws DAOException {
        ...
        dao.put(con, new UserTwitterLink(EVENT_VIP_ENROLLED_USER_TWITTER_LINK_ID, EVENT_VIP_ENROLLED_USER_TWITTER_ID, EVENT_VIP_ENROLLED_USER_ID, EVENT_VIP_ENROLLED_USER_TWITTER_SCREENNAME, "testUser 4", "accessToken", "accessTokenSecret", "http://www.example.com/"));
