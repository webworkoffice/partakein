...
//
//	/**
//	 * {@link DeprecatedEventsEditController#editNew()}メソッドについて、以下のように
//	 * 実装されていることを保証する。
//	 * <ul>
...
//		DeprecatedEventsEditController controller = new DeprecatedEventsEditController();
...
//
//		controller = new DeprecatedEventsEditController();
//		controller.setSession(session);
